        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Produto_Estoque", "\"Estoque\" >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricosPedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoricosPedido_Pedidos_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_Documento_Ativo",
                table: "Clientes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoricosPedido_PedidoId",
                table: "HistoricosPedido",
                column: "PedidoId");
